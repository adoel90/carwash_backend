...
export class ApiRoutes extends Routes{
	...
	routes(){
		...
		/* Start Vendor routes */
		this.app.get("/vendor/list", (req, res) => {
			let param = {
				limit: req.query.limit ? req.query.limit : 10,
				offset: req.query.offset ? req.query.offset : 0,
			...
			cafeController.cafeList(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		this.app.get("/vendor/detail", (req, res) => {
			let param = {
				id: req.query.id ? req.query.id : null
			}
			...
			cafeController.cafeDetail(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		// this.app.get("/employee/list", (req, res) => {
		// 	let param = {
		// 		id: req.query.id ? req.query.id : null
		// 	}
		...
		// 	employeeController.employeeListByUser(param).then((data) => {
		// 		return this.success(res, data);
		// 	}).catch((err) => {
		// 		return this.error(res, err);
		// 	});
		...
		// this.app.get("/employee/detail", (req, res) => {
		// 	let param = {
		// 		id: req.query.id ? req.query.id : null
		// 	}
		...
		// 	employeeController.employeeById(param).then((data) => {
		// 		return this.success(res, data);
		// 	}).catch((err) => {
		// 		return this.error(res, err);
		// 	});
		...
		// this.app.post("/employee/create", (req, res) => {
		// 	let param = {
		// 		name: req.body.name,
		// 		username: req.body.username,
