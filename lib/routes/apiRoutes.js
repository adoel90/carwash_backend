...
export class ApiRoutes extends Routes{
	...
	routes(){
		...
		this.app.post("/admin/authenticate", (req, res) => {
			let param = {
		...
		this.app.get("/admin/user/list", verifyToken, (req, res) => {
			let param = {
		...
		this.app.get("/admin/user/detail", verifyToken, (req, res) => {
			let param = {
				id : req.query.id
			}
		...
		this.app.post("/admin/user/create", verifyToken, (req, res) => {
			let param = {
				username : req.body.username,
				password : req.body.password,
				name : req.body.name,
		...
		this.app.put("/admin/user/update", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				username : req.body.username,
		...
		this.app.put("/admin/user/status", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.get("/admin/access/list", verifyToken, (req, res) => {
			let param = {};
		...
		this.app.get("/admin/access/detail", verifyToken, (req, res) => {
			let param = {
				id : req.query.id
			}
		...
		this.app.post("/admin/access/create", verifyToken, (req, res) => {
			let param = {
				name : req.body.name,
		...
		this.app.put("/admin/access/update", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name,
				module : req.body.module
		...
		this.app.put("/admin/access/status", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.get("/admin/module", verifyToken, (req, res) => {
			let param = {}
		...
		this.app.get("/vendor/list", verifyToken, (req, res) => {
			let param = {};
		...
		this.app.post("/vendor/create", verifyToken, (req, res) => {
			let param = {
				name : req.body.name,
				user : req.body.user
			}
		...
		this.app.put("/vendor/update", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name
			}
		...
		this.app.put("/vendor/delete", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.put("/vendor/status", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		/* Start Cafe routes */
		this.app.post("/vendor/authenticate", (req, res) => {
			let param = {
				username: req.body.username,
				password: req.body.password
			}

			cafeController.authenticate(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		this.app.get("/vendor/employee/list", verifyToken, (req, res) => {
			let param = {
			...
			employeeController.employeeList(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		this.app.get("/vendor/employee/detail", verifyToken, (req, res) => {
			let param = {
				id : req.query.id
			}

			employeeController.employeeDetail(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		this.app.post("/vendor/employee/create", verifyToken, (req, res) => {
			let param = {
				name : req.body.name,
			...
			employeeController.createEmployee(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		this.app.put("/vendor/employee/update", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name,
				email : req.body.email,
			...
			employeeController.updateEmployee(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		this.app.put("/vendor/employee/delete", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				cafe : req.body.cafe
			}

			employeeController.deleteEmployee(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
		...
		this.app.get("/vendor/menu", verifyToken, (req, res) => {
			let param = {
		...
		this.app.get("/vendor/menu/list", verifyToken, (req, res) => {
			let param = {
				cf_id : req.query.cafe,
				limit : req.query.limit ? req.query.limit : 10,
				offset : req.query.offset ? req.query.offset : 0,
		...
		this.app.post("/vendor/menu/create", verifyToken, this.upload.single('image'), (req, res) => {
			let param = {
				cf_id : req.body.cafe,
				name : req.body.name,
		...
		this.app.put("/vendor/menu/update", verifyToken, this.upload.single("image"), (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name,
				price : req.body.price,
		...
		this.app.put("/vendor/menu/delete", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.put("/vendor/menu/status", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.post("/vendor/transaction/create", verifyMemberToken, (req, res) => {
			let param = {
		...
		this.app.get("/vendor/transaction/print", verifyToken, (req, res) => {
			let param = {
				id : req.query.id
			}
		...
		this.app.get("/vendor/report", verifyToken, (req, res) => {
			let param = {
			...
			cafeController.cafeReport(param).then((data) => {
				return this.success(res, data);
			}).catch((err) => {
				return this.error(res, err);
			});
