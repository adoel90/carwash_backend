...
export class ApiRoutes extends Routes{
	...
	routes(){
		...
		this.app.get("/admin/cafe/list", verifyToken, (req, res) => {
			let param = {};
		...
		this.app.post("/admin/cafe/create", verifyToken, (req, res) => {
			let param = {
				name : req.body.name,
				user : req.body.user
			}
		...
		this.app.put("/admin/cafe/update", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name
			}
		...
		this.app.put("/admin/cafe/delete", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.put("/admin/cafe/status", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		/* Start Cafe routes */
		this.app.post("/cafe/authenticate", (req, res) => {
			let param = {
				username: req.body.username,
				password: req.body.password
			}
		...
		this.app.get("/cafe/employee/list", verifyToken, (req, res) => {
			let param = {
		...
		this.app.get("/cafe/employee/detail", verifyToken, (req, res) => {
			let param = {
				id : req.query.id
			}
		...
		this.app.post("/cafe/employee/create", verifyToken, (req, res) => {
			let param = {
				name : req.body.name,
		...
		this.app.put("/cafe/employee/update", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name,
				email : req.body.email,
		...
		this.app.put("/cafe/employee/delete", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				cafe : req.body.cafe
			}
		...
		this.app.post("/cafe/transaction/create", verifyMemberToken, (req, res) => {
			let param = {
				member : req.body.member, //res.locals.member.id,
				menu : req.body.menu,
				cafe : req.body.cafe
			}
		...
		this.app.get("/cafe/report", verifyToken, (req, res) => {
			let param = {
