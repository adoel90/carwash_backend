...
export class ApiRoutes extends Routes{
	...
	routes(){
		...
		this.app.get("/store/promo/list", verifyToken, (req, res) => {
			let param = {
				id : req.query.id
			}
		...
		this.app.get("/store/promo/detail", verifyToken, (req, res) => {
			let param = {
				id : req.query.id
			}
		...
		this.app.post("/store/promo/create", verifyToken, (req, res) => {
			let param = {
		...
		this.app.put("/store/promo/update", verifyToken, (req, res) => {
			let param = {
				id : req.body.id,
				price : req.body.price
			}
		...
		this.app.put("/store/promo/delete", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.put("/store/promo/status", verifyToken, (req, res) => {
			let param = {
				id : req.body.id
			}
