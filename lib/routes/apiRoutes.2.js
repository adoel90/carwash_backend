...
export class ApiRoutes extends Routes{
	...
	routes(){
		...
		this.app.get("/vendor/list", verifyCafeToken, (req, res) => {
			let param = {};
		...
		this.app.post("/vendor/create", verifyCafeToken, (req, res) => {
			let param = {
		...
		this.app.put("/vendor/update", verifyCafeToken, (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name
			}
		...
		this.app.put("/vendor/delete", verifyCafeToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.put("/vendor/status", verifyCafeToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.get("/vendor/employee/list", verifyCafeToken, (req, res) => {
			let param = {
		...
		this.app.get("/vendor/employee/detail", verifyCafeToken, (req, res) => {
			let param = {
				id : req.query.id
			}
		...
		this.app.post("/vendor/employee/create", verifyCafeToken, (req, res) => {
			let param = {
				name : req.body.name,
				email : req.body.email,
				username : req.body.username,
		...
		this.app.put("/vendor/employee/update", verifyCafeToken, (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name,
				email : req.body.email,
		...
		this.app.put("/vendor/employee/delete", verifyCafeToken, (req, res) => {
			let param = {
				id : req.body.id,
				cafe : req.body.cafe
			}
		...
		this.app.get("/vendor/menu", verifyCafeToken, (req, res) => {
			let param = {
		...
		this.app.get("/vendor/menu/list", verifyCafeToken, (req, res) => {
			let param = {
				cf_id : req.query.cafe,
				limit : req.query.limit ? req.query.limit : 10,
				offset : req.query.offset ? req.query.offset : 0,
		...
		this.app.post("/vendor/menu/create", verifyCafeToken, this.upload.single('image'), (req, res) => {
			let param = {
				cf_id : req.body.cafe,
				name : req.body.name,
		...
		this.app.put("/vendor/menu/update", verifyCafeToken, this.upload.single("image"), (req, res) => {
			let param = {
				id : req.body.id,
				name : req.body.name,
				price : req.body.price,
		...
		this.app.put("/vendor/menu/delete", verifyCafeToken, (req, res) => {
			let param = {
				id : req.body.id
			}
		...
		this.app.put("/vendor/menu/status", verifyCafeToken, (req, res) => {
			let param = {
				id : req.body.id
			}
